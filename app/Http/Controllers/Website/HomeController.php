...
class HomeController extends Controller
{
    public function home(Request $request){
        ...
        $latest_products = Product::where('status',1)->orderBy('created_at','desc')->limit(4)->get();
        $trending_products = Product::where('status',1)->where('trending',1)->limit(4)->get();
        $new_arrivals = Product::where('status',1)->orderBy('created_at','desc')->limit(4)->get();
